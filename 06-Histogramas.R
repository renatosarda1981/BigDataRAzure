...
hist(dados, main = 'Números de Acidentes Diários', xlab = "Acidentes", ylab = 'Frequência', breaks = 6)
hist(dados, main = 'Números de Acidentes Diários', xlab = "Acidentes", ylab = 'Frequência', breaks = 5)